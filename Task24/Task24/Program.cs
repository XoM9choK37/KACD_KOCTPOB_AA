...
namespace Task24
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            set.PrintWithColors();
            SortedSet<int> sortedSet = set.DescendingSet();
    ...
    class MyTreeSet<T> where T : IComparable<T>
    {
        ...
        public void Remove(T element)
        {
            Node<T> currentNode = root;
            while (currentNode != null &&
                comparator.Compare(element, currentNode.data) != 0)
            {
            ...
            while (node != root && node.parent.color == Color.Red)
                if (node.parent == node.parent.parent.left)
                {
                    ...
                    else
                    {
                        ...
                        node.parent.color = Color.Black;
                        node.parent.parent.color = Color.Red;
                        RightChange(node.parent.parent);
                    }
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        node.parent.color = Color.Black;
                        node.parent.parent.color = Color.Red;
                        LeftChange(node.parent.parent);
                    }
                }
            root.color = Color.Black;
        }
        private void LeftChange(Node<T> node)
        {
        ...
        private void RightChange(Node<T> node)
        {
