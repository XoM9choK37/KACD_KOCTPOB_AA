...
namespace Task23
{
    class MyHashSet<T> : MyIterator1<T>, MySet<T>
    {
        ...
        public MyHashSet(MyCollection<T> collection)
        {
        ...
        public T First()
        {
            return map.KeysToList().GetFirst();
        }
        public T Last()
        {
            return map.KeysToList().GetLast();
        }
        public MyHashMap<T, object> SubSet(T fromElement, T toElement)
        {
            T[] array = map.KeysToList().SubList(map.KeysToList().IndexOf(fromElement),
                map.KeysToList().IndexOf(toElement));
            var set = new MyHashMap<T, object>();
            foreach (T element in array)
                set.Put(element, 0);
            return set;
        }
        ...
        {
            T[] array = map.KeysToList().SubList(0,
                map.KeysToList().IndexOf(toElement));
            var set = new MyHashMap<T, object>();
            foreach (T element in array)
                set.Put(element, 0);
