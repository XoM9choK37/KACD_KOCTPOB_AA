...
namespace Task18
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            myHashMap.Put("Banana", 100);
            myHashMap.Put("Orange", 200);
            myHashMap.Put("Cabbage", 200);
            myHashMap.Print();
            Console.Write("\n");
            Console.WriteLine(myHashMap.Get("Orange"));
            Console.WriteLine(myHashMap.Get("Potato"));
            Console.Write("\n");
            myHashMap.Put("Cucumber", 50);
            myHashMap.Put("Orange", 350);
            myHashMap.Print();
            Console.Write("\n");
            myHashMap.EntrySet().Print();
            Console.Write("\n");
            myHashMap.KeySet().Print();
            Console.Write("\n");
        }
    }
    class MyHashMap<K, V>
